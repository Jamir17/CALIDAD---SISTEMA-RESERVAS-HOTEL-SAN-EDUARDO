...
-- Volcando datos para la tabla bd_hotel_san_eduardo.facturacion: ~47 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_hotel_san_eduardo.historial_notificaciones: ~26 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_hotel_san_eduardo.reserva_servicio: ~32 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_hotel_san_eduardo.valoraciones: ~0 rows (aproximadamente)
